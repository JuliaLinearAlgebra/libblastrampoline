...
# Vendor functions for MKL that we will forward (until we have a cohesive vendor-neutral API for this)
MKL_VENDOR_FUNCS="mkl_get_max_threads mkl_get_max_threads_ MKL_Set_Num_Threads MKL_Set_Num_Threads_ MKL_Set_Interface_Layer MKL_Set_Interface_Layer_"

# These are all the symbols we will export
EXPORTED_FUNCS="`cut -b2-100 tempsymbols.def` ${MKL_VENDOR_FUNCS}"
